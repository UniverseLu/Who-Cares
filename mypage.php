...
<div id="right">
    <div id='inner'>
        <div id = 'fixinfo' style="margin-left: 0;width: 100%; padding-left: 10px"><span >Order</span></div>
        ...
        $sqlOrder="SELECT DISTINCT ORDERID,BUSSID,STATUS,ORDERTIME, TO_CHAR(ORDERTIME, 'MON-DD-YYYY HH24:MI:SS') TIME_STR,DELIVERYTIME,DELIVERYMETHOD, BRANDNAME
                   FROM G14ORDER,G14BRANDNAME, G14RESTAURANT
                   WHERE CUSTID='$userID' AND G14BRANDNAME.BRANDID=G14RESTAURANT.BRANDID AND G14RESTAURANT.USRID=G14ORDER.BUSSID
        ...
        for($j=0; $j <= $orderRows-1; $j++) {
            ...
            for ($i = 0; $i <= $nrows - 1; $i++) {
                ...
                echo"</dl><input id='orders' onclick='updateorder()' class=update  value='Rate' style='margin-left: 20%' readonly='readonly'/>
               </form></div>";
        ?>
...
<script>
    ...
    function updateorder() {
        ...
        if(document.getElementById("orders").value=="Confirm"){
            ...
            document.getElementById("orders").style.width="200px";
            document.getElementById("orders").style.height="30px";
            document.getElementById("orders").type="submit";
        }
