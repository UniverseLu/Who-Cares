...
//                $state = $_GET['states'];
                ...
                echo"<div id='sort' style='display: block;'><section id='sortby'>Sort By</section>";
...
//                    echo "</li>";
    ...
    <div id="left" style="float:left;width:200px; background-color: #FF9966; height: 100%; color: white;">
