...
{	
	...
	else
	{
		...
		if($c==1){
		        ...
		        if($usertype=="m"){
					// go to manager page
					echo "<script type='text/javascript'>window.location.replace('manager_analytic.php');</script>";
				} else if ($usertype=="b"){
					// go to providerpage
					echo "<script type='text/javascript'>window.location.replace('ProviderPage.php');</script>";
				} else
		        // go to LogInIndex
			    echo "<script type='text/javascript'>window.location.replace('LogInIndex.html');</script>";   //test for my page
				//echo "<script type='text/javascript'>window.location.replace('index.html');</script>";
